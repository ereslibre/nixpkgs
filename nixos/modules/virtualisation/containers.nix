...
let
  ...
  inherit (lib) literalExpression mkOption mkRenamedOptionModule types;
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    hardware.nvidia-container-toolkit.enable = lib.mkIf cfg.cdi.dynamic.nvidia.enable true;
