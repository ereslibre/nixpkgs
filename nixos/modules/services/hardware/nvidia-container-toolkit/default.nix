...

{
  ...
  options = {
    ...
    hardware.nvidia-container-toolkit.enable = lib.mkOption {
      default = false;
      type = lib.types.bool;
  ...
  config = {
    ...
    systemd.services.nvidia-container-toolkit = lib.mkIf config.hardware.nvidia-container-toolkit.enable {
